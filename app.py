...
def _prewarm():
    ...
    cidades = [c.strip() for c in os.environ.get("PREWARM_CIDADES", "Porto").split(",") if c.strip()]
    for c in cidades:
        try:
            carregar_anuncios(c, 2)
        except Exception:
            pass
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("Aloja-Te a correr em http://0.0.0.0:%d (waitress)" % PORT)
